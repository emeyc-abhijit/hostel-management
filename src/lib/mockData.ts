import { Student, Room, Complaint, LeaveRequest, Notification, Fee, HostelAdmission, EntryExitRequest } from '@/types';
...
export const mockComplaints: Complaint[] = [
  {
    ...
    wardenReviewedAt: '2024-01-15T14:00:00Z',
    wardenReviewedBy: 'Warden Singh',
    escalationDeadline: '2024-01-16T10:30:00Z',
  },
  {
    id: '2',
    studentId: '2',
    ...
    wardenReviewedAt: '2024-01-14T16:00:00Z',
    wardenReviewedBy: 'Warden Singh',
    adminReviewedAt: '2024-01-15T09:00:00Z',
    adminReviewedBy: 'Admin Kumar',
  },
  {
    id: '3',
    studentId: '3',
    ...
    wardenReviewedAt: '2024-01-13T10:00:00Z',
    wardenReviewedBy: 'Warden Singh',
    adminReviewedAt: '2024-01-13T14:00:00Z',
    adminReviewedBy: 'Admin Kumar',
    higherManagementReviewedAt: '2024-01-14T16:00:00Z',
    higherManagementReviewedBy: 'Director Sharma',
  },
  {
    id: '4',
    studentId: '4',
...
// Hostel Admissions Mock Data
export const mockAdmissions: HostelAdmission[] = [
  {
    id: '1',
    studentName: 'Vikram Rao',
    email: 'vikram.rao@medhavi.edu',
    phone: '+91 9876543230',
    course: 'B.Tech Computer Science',
    year: 1,
    guardianName: 'Mr. Mohan Rao',
    guardianPhone: '+91 9876543231',
    address: '456 Brigade Road, Bangalore, Karnataka 560001',
    preferredHostel: 'Block A',
    roomType: 'double',
    status: 'pending',
  ...
  },
  {
    ...
    email: 'rohan.mehta@medhavi.edu',
    phone: '+91 9876543234',
    course: 'B.Sc Physics',
    year: 1,
    guardianName: 'Dr. Ashok Mehta',
    guardianPhone: '+91 9876543235',
    address: '321 Park Avenue, Pune, Maharashtra 411001',
    preferredHostel: 'Block A',
    roomType: 'triple',
    status: 'pending',
...
// Entry/Exit Requests Mock Data
export const mockEntryExitRequests: EntryExitRequest[] = [
  {
    id: '1',
    studentId: '1',
    studentName: 'Rahul Kumar',
    ...
    purpose: 'Going home for family function - cousin\'s wedding',
  ...
  },
  {
    ...
    purpose: 'Medical appointment with specialist in Mumbai',
    destination: 'Mumbai',
    contactDuringAbsence: '+91 9876543212',
    status: 'approved',
    createdAt: '2024-01-12T14:30:00Z',
    approvedBy: 'Warden Singh',
    approvedAt: '2024-01-13T09:00:00Z',
  },
  {
    ...
    purpose: 'Returning early from winter break',
    destination: 'Ahmedabad',
    contactDuringAbsence: '+91 9876543214',
    status: 'approved',
    createdAt: '2024-01-14T10:00:00Z',
    approvedBy: 'Warden Singh',
    approvedAt: '2024-01-14T11:00:00Z',
    remarks: 'Late entry approved. Room will be available.',
  },
  {
    id: '4',
    studentId: '5',
    ...
    purpose: 'Attending cultural fest in another city',
    destination: 'Kolkata',
    contactDuringAbsence: '+91 9876543218',
    status: 'rejected',
    createdAt: '2024-01-13T16:00:00Z',
    approvedBy: 'Warden Singh',
    approvedAt: '2024-01-14T09:00:00Z',
    remarks: 'Dates coincide with mid-term examinations. Request cannot be approved.',
  },
];
